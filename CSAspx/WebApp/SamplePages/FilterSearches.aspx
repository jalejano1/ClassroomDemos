<%@ Page Title="Filter Searches" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FilterSearches.aspx.cs" Inherits="WebApp.SamplePages.FilterSearches" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="View3" runat="server">
                <fieldset class="form-horizontal">
                    ...
                    <br />
                    <br />
                    <asp:GridView ID="ProductGridViewV3" runat="server" OnSelectedIndexChanged="ProductGridViewV3_SelectedIndexChanged">
                        <Columns>
            ...
            <asp:View ID="View4" runat="server">
             ...
             <asp:View ID="View5" runat="server">
                <fieldset class="form-horizontal">
                    ...
                    <asp:Button ID="FindSupplierCategoryProducts" runat="server" Text="Products?" Enabled="false" />
