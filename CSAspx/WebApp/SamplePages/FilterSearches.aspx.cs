...
namespace WebApp.SamplePages
{
    public partial class FilterSearches : System.Web.UI.Page
    {
        ...
        {
            //this method swithes the user between views on the form
            //the value associated with MenuItem is treated as an index
            int index = Int32.Parse(e.Item.Value);
            //ActiveViewIndex determins which view is displayed
